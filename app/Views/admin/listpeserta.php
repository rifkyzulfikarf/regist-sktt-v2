...
<link href="<?=base_url('adm-template/plugins/datatables/datatables.min.css')?>" rel="stylesheet">
</head>
        ...
        <div class="col">
            <div class="page-description d-flex align-items-center">
                <div class="page-description-content flex-grow-1">
                    <h1>Daftar Peserta Lomba Menggambar dan Mewarnai<br>Hari Hak Asasi Manusia Sedunia ke-77</h1>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?=base_url('adm-template/plugins/datatables/datatables.min.js')?>"></script>

<script type="text/javascript">
    $(document).ready(function () {

        $('#tbl-peserta-warnai').DataTable();
        $('#tbl-peserta-gambar').DataTable();
